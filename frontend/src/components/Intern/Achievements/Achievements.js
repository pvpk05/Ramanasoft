      ...
      <div className="offerletter" ref={certificateRef} >
        ...
        <p>
          ...
          <div style={{ marginLeft: "20px" }}>
            •	Work with a variety of technologies and programming languages and tools.<br />
            •	Learn and apply software development methodologies such as Agile and Waterfall models.<br />
            •	Develop your coding and debugging skills under experts guidance.<br />
            •	Learn about software testing and quality assurance processes.<br />
            •	Collaborate with teams to create and deliver software solutions.<br />
            •	Explore the software industry and network with field professionals.<br />
          </div>
        </p>
        <p>
...
const Achievements = () => {
  ...
  const handleCardClick = (type) => {
    if (type === "certificate" && !certificateUnlocked) {
      return; // Prevent opening the modal if the certificate is locked
    }
    setActiveModal(type); // Set the active modal only if the condition is met
  };
