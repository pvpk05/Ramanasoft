...
const degreeBranchMap = {
  ...
  "Master of Computer Applications (MCA)": ["Software Development", "Web Development", "Mobile Application Development", 
    "Data Science", "Artificial Intelligence", "Machine Learning", "Cloud Computing",
    "Cybersecurity", "Network Administration", "Database Management", "Information Systems", "Big Data Analytics", "Embedded Systems", "Internet of Things (IoT)",
    "Enterprise Resource Planning (ERP)", "Game Development", "Blockchain Technology", "E-Commerce",
    "UI/UX Design", "DevOps"
  ],
...
const JobPortal = ({ setSelectedView }) => {
  ...
  const fetchInternDetails = async () => {
    try {
      const response = await apiService.get(`/api/intern_data/${candidateID}`);
