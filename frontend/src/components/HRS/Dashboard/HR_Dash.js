...
import { faBars, faSignOutAlt, faTimes, faBell, faUser, faSignOut } from '@fortawesome/free-solid-svg-icons';
...
import InternTable from '../intern_data/internData';
import GuestData from '../intern_data/guestData';
import DomainAndBatch from '../Domain/DomainAndBatch'
import CertificateApp from '../PlacementCertificate/PlacementCertificate';
...
const HRDash = () => {
  ...
  const menuItems = [
    ...
    { id: 'placementCertificate', name: 'Placement Certificate', icon: 'fa fa-file-alt' },

    { id: 'domainBatch', name: 'Manage Domains', icon: 'fas fa-sticky-note' },
    {
    ...
    <div className={`dashboard ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <div className={`main-content ${isSidebarOpen ? 'expanded' : 'collapsed'}`}>
        <div className="top-panel">
          ...
          <div className="container-lg" style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", marginTop: "10px", marginBottom: "10px" }}>
            ...
            <button
              style={{ color: "white", width: "27px", height: "27px", background: "none", border: "none", borderRadius: "200%", cursor: "pointer", outline: "none", marginRight: "15px" }}
              onClick={logout}
              title='Signout'
            >
              <FontAwesomeIcon
